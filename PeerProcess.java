...
public class PeerProcess {
	...
	public void initializePreferredNeighbors() {
		...
		// localPeerID + " has the preferred neighbors " + "["
		// + peer_list.toString() + "]" + ".");
	...
	public void updatePieceRequested(int pieceToBeRequestedFromPeer) {
		...
		synchronized (piecesRemainingToBeRequested) {
			...
			// Util.printArrayListOfIntegersFromLocalPeer(piecesRemainingToBeRequested,
			// this.localPeerID,
			// pieceToBeRequestedFromPeer, "piecesRemainingToBeRequestedMap in
			// updatePieceRequested()");
		}
		synchronized (piecesRequested) {
			this.piecesRequested.put(pieceToBeRequestedFromPeer, pieceToBeRequestedFromPeer);
			// Util.printArrayListOfIntegersFromLocalPeer(piecesRequested,
			// this.localPeerID, pieceToBeRequestedFromPeer,
